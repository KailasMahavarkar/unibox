                    ...
                    <div className="grid gap-4">
                      ...
                      <div className="flex items-start justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="font-medium text-sm mb-2">Linked Accounts</div>
                            <div className="text-xs text-gray-500 mb-3">Account listing section with filters</div>
                            {/* Mini UI Preview */}
                            <div className="bg-white border rounded p-2 text-xs">
                              <div className="flex gap-1 mb-2">
                                <div className="bg-blue-600 text-white px-2 py-1 rounded-full text-xs">ALL</div>
                                <div className="border px-2 py-1 rounded-full text-xs">BANK</div>
                                <div className="border px-2 py-1 rounded-full text-xs">STOCKS</div>
                              </div>
                              <div className="space-y-1">
                                <div className="flex items-center gap-2">
                                  ...
                                  <div className="font-medium">₹48K</div>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <Switch
                          checked={config.insights.showLinkedAccounts}
                          onCheckedChange={(checked) => handleInsightChange("showLinkedAccounts", checked)}
                        />
                      </div>

                      <Separator />
                      <div className="text-sm font-medium text-gray-700">Account Types</div>
                      ...
                      <div className="flex items-start justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="font-medium text-sm mb-2">Bank Accounts</div>
                            <div className="text-xs text-gray-500 mb-3">Show bank account listings in overview</div>
                            {/* Mini UI Preview */}
                            <div className="bg-white border rounded p-2 text-xs">
                              <div className="font-bold mb-1">BANK ACCOUNTS</div>
                              <div className="flex items-center gap-2">
                                <div className="w-4 h-4 bg-blue-900 rounded text-white text-xs flex items-center justify-center">
                                  K
                                </div>
                                <div className="flex-1">
                                  <div className="font-medium">Kotak Mahindra Bank</div>
                                  <div className="text-gray-500">xx1611</div>
                                </div>
                                <div className="font-medium">₹48K</div>
                              </div>
                        ...
                        <Switch
                          checked={config.insights.showBankAccounts}
                          onCheckedChange={(checked) => handleInsightChange("showBankAccounts", checked)}
                        />
                      </div>
                      ...
                      <div className="flex items-start justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-start gap-3">
                          <LineChart className="h-4 w-4 text-green-600 mt-1" />
                          <div className="flex-1">
                            <div className="font-medium text-sm mb-2">Stocks</div>
                            <div className="text-xs text-gray-500 mb-3">Show stock holdings in overview</div>
                            {/* Mini UI Preview */}
                            <div className="bg-white border rounded p-2 text-xs">
                              <div className="font-bold mb-1">STOCKS</div>
                              <div className="flex items-center gap-2">
                                <div className="w-4 h-4 bg-cyan-500 rounded text-white text-xs flex items-center justify-center">
                                  G
                                </div>
                                <div className="flex-1">
                                  <div className="font-medium">Groww</div>
                                  <div className="text-gray-500">xx1334</div>
                                </div>
                        ...
                        <Switch
                          checked={config.insights.showStocks}
                          onCheckedChange={(checked) => handleInsightChange("showStocks", checked)}
                        />
                      </div>
                      ...
                      <div className="flex items-start justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="font-medium text-sm mb-2">ETFs</div>
                            <div className="text-xs text-gray-500 mb-3">Show ETF holdings in overview</div>
                            {/* Mini UI Preview */}
                            <div className="bg-white border rounded p-2 text-xs">
                              <div className="font-bold mb-1">ETF</div>
                              <div className="flex items-center gap-2">
                                <div className="w-4 h-4 bg-cyan-500 rounded text-white text-xs flex items-center justify-center">
                                  G
                                </div>
                                ...
                                <div className="font-medium">₹2L</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <Switch
                          checked={config.insights.showETF}
                          onCheckedChange={(checked) => handleInsightChange("showETF", checked)}
                        />
                      </div>
                      ...
                      <div className="flex items-start justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-start gap-3">
                          <Target className="h-4 w-4 text-red-600 mt-1" />
                          <div className="flex-1">
                            <div className="font-medium text-sm mb-2">Mutual Funds</div>
                            <div className="text-xs text-gray-500 mb-3">Show mutual fund holdings in overview</div>
                            {/* Mini UI Preview */}
                            <div className="bg-white border rounded p-2 text-xs">
                              <div className="font-bold mb-1">MUTUAL FUNDS</div>
                              <div className="flex items-center gap-2">
                                <div className="w-4 h-4 bg-red-800 rounded text-white text-xs flex items-center justify-center">
                                  A
                                </div>
                                <div className="flex-1">
                                  <div className="font-medium">Axis Mutual Fund</div>
                                  <div className="text-gray-500">xx1614</div>
                                </div>
                                <div className="font-medium">₹1.9L</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <Switch
                          checked={config.insights.showMutualFunds}
                          onCheckedChange={(checked) => handleInsightChange("showMutualFunds", checked)}
                        />
                      </div>
                    </div>
                  </AccordionContent>
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <CardDescription className="text-sm">Switch to dark theme</CardDescription>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="pt-0">
                        <Switch
                          ...
                          onCheckedChange={(checked) => handleUIChange("darkMode", checked)}
                        />
                      </CardContent>
                    </Card>
                  </div>
