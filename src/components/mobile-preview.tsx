        ...
        <div className="flex-1 overflow-y-auto">
            ...
            <div className="mx-4 mb-4 flex gap-2 overflow-x-auto">
                <Button
                    ...
                    className={`rounded-full px-6 whitespace-nowrap ${selectedDateRange === "Today"
                            ? "text-white"
                            : isDarkMode
                ...
                <Button
                    ...
                    className={`rounded-full px-6 whitespace-nowrap ${selectedDateRange === "This week"
                            ? "text-white"
                            : isDarkMode
                                ? "bg-gray-800 text-gray-300"
                                : "text-gray-700"
                ...
                <Button
                    ...
                    className={`rounded-full px-6 whitespace-nowrap ${selectedDateRange === "This month"
                            ? "text-white"
                            : isDarkMode
                                ? "bg-gray-800 text-gray-300"
                                : "text-gray-700"
                    ...
                    <div className={`border rounded-lg p-4 mb-4 ${cardClasses}`}>
                        ...
                        <div className="flex gap-2 mb-4">
                            {["Credit", "Debit", "Payees"].map((type) => (
                                <Badge
                                    key={type}
                                    className={`cursor-pointer ${selectedTransactionType === type
                                            ? "text-white"
                                            : "bg-primary"
                                        }`}
                                    style={{
